    ...
    def setup_board(self):
        ...
        for i in range(self.tiles_y):
            ...
            for f in range(self.tiles_x):
                ...
                points = [{"x": x, "y": y},{"x": x + self.side_length, "y": y + self.side_length}]
...
class View(object):
    def __init__(self):
        ...
        self.canvas = Canvas(root, width=game_board.tiles_x * game_board.side_length, height=game_board.tiles_y * game_board.side_length)
    ...
    def create_canvas_tile(self, points):
        return self.canvas.create_rectangle(points[0]['x'], points[0]['y'], points[1]['x'], points[1]['y'], fill=game_board.default_colour)
